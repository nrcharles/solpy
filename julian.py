...
def JulianCentury(julian_day):
    return (julian_day - 2451545.0) / 36525.0

def JulianDay(utc_datetime):
...
def JulianEphemerisCentury(julian_ephemeris_day):
    return (julian_ephemeris_day - 2451545.0) / 36525.0

def JulianEphemerisDay(julian_day, delta_seconds = 66.0):
...
def JulianEphemerisMillenium(julian_ephemeris_century):
